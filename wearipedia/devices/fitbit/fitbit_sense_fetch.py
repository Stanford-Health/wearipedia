...
def fetch_real_data(data_type, access_token, start_date, end_date=None):
    ...
    categories = {
        ...
        "intraday_active_zone_minute": {
            "url": f"https://api.fitbit.com/1/user/-/activities/active-zone-minutes/date/{start_date}/{end_date}/1d/1min.json"
        },
        "intraday_activity": {
            "url": f"https://api.fitbit.com/1/user/-/activities/steps/date/{start_date}/{end_date}/1d/1min.json"
        },
        "intraday_heart_rate": {
            "url": f"https://api.fitbit.com/1/user/-/activities/heart/date/{start_date}/{end_date}/1d/1sec.json"
        },
        "intraday_hrv": {
