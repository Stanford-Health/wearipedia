                    ...
                    "point": [
                        {
                            ...
                            "value": [{"fpVal": syn_sleep_duration(0), "mapVal": []}],
                        }
                    ],
                }
            ]
                    ...
                    "point": [
                        {
                            ...
                            "value": [
                                {"fpVal": syn_blood_pressure_sys(0), "mapVal": []},
                                {"fpVal": syn_blood_pressure_dia(0), "mapVal": []},
                                {"fpVal": syn_blood_pressure_dia(0), "mapVal": []},
                                {"fpVal": syn_blood_pressure_dia(0), "mapVal": []},
                                {"fpVal": syn_blood_pressure_dia(0), "mapVal": []},
                                {"intVal": 2, "mapVal": []},
                    ...
                    "point": [
                        {
                            ...
                            "value": [
                                {"fpVal": syn_calories_expended(0), "mapVal": []},
                            ],
                        }
                    ],
                }
                    ...
                    "point": [
                        {
                            ...
                            "value": [
                                {"fpVal": float(syn_menstruation(0)), "mapVal": []}
                            ],
                        }
                    ],
                }
                    ...
                    "point": [
                        {
                            ...
                            "value": [
                                {"fpVal": syn_body_temperature(0), "mapVal": []},
                                {"fpVal": syn_body_temperature(0), "mapVal": []},
                                {"fpVal": syn_body_temperature(0), "mapVal": []},
                            ],
                        }
                    ...
                    "point": [
                        {
                            ...
                            "value": [
                                {"fpVal": syn_oxygen_saturation(0), "mapVal": []},
                                {"fpVal": syn_oxygen_saturation(0), "mapVal": []},
                                {"fpVal": syn_oxygen_saturation(0), "mapVal": []},
