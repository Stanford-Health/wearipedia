...
class BaseDevice:
    ...
    * authenticate
    ...
    def _get_synthetic(self, data_type, params):
        ...
        except that it should return synthetic data instead of real data. The intention is for
        this method to not generate new synthetic data itself, but rather to return the data
        that was generated by _gen_synthetic().
